...
var queryUrl = "https://raw.githubusercontent.com/nancyecampos/sandbox/master/glasssponge.geojson";
...
function createMap(corals) {
  ...
  for (coral of corals) {
    ...
    L.circleMarker(latlon, { // create the circle
      ...
      color: 'orange', 
      radius: 1.0
    }).addTo(myMap).bindPopup(`coral: ${coral.properties.commonname}, source: ${coral.properties.source}, year discovered: ${coral.properties.year}`); // add the layer to your map
  }
